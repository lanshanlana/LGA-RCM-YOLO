...
#补丁1
# ========== 自定义层导入（仅保留你需要的LGA/C3k2_RCM/ASPP）==========
from ultralytics.nn.Attention.LGA import LocalGlobalAttention as LGA
from ultralytics.nn.modules.block import ASPP, C3k2_RCM
...
def parse_model(d, ch, verbose=True):
    ...
    """
    #补丁2
     # 自定义层全局注册，解决KeyError: LGA
    global LGA, C3k2_RCM, ASPP
    globals()["LGA"] = LGA
    globals()["C3k2_RCM"] = C3k2_RCM
    globals()["ASPP"] = ASPP
    import ast
